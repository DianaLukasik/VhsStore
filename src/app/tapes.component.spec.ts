...
describe('TapesComponent', function () {
    let de: DebugElement;
    ...
    beforeEach(async(() => {
        TestBed.configureTestingModule({
            declarations: [
                TapesComponent, VhsEditComponent, VhsDetailComponent, SortPipe, MovieFilterPipe, FreePipe
            ],
    ...
    it('should sort by title', () => {
        comp.sortBy('title');
        expect(comp.sortType).toBe('title');
    });

    it('should sort by id', () => {
        comp.sortBy('id');
        expect(comp.sortType).toBe('id');
    });
    ...
    it('should have expected <h4> text', () => {
        head = fixture.debugElement.query(By.css('h4'));
        el = head.nativeElement;
        fixture.detectChanges();
        expect(el.textContent).toContain('Free Tapes');
